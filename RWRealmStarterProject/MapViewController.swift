  ...
  //MARK: - Realm
    func populateMap() {
        ...
        for specimen in specimens {
            ...
            let coord = CLLocationCoordinate2DMake(aSpecimen.latitude, aSpecimen.longtitude)
    ...
    func updateLocationDistance() {
        ...
        for specimen in specimens {
            ...
            let currentLocation = CLLocation(latitude: currentSpecimen.latitude, longitude: currentSpecimen.longtitude)
...
//    lastAnnotation = nil;
    ...
    let addedSpecimenCoordinate = CLLocationCoordinate2DMake(addedSpecimen.latitude, addedSpecimen.longtitude)
